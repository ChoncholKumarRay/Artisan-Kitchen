  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <div className="w-64 bg-white shadow-lg p-6">
        <h2 className="text-2xl font-bold text-orange-600 mb-6">Admin Panel</h2>
        <nav className="space-y-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-red-100 text-red-600 hover:bg-red-200 rounded-md font-medium transition"
          >
            <FaSignOutAlt /> Logout
          </button>
        </nav>
